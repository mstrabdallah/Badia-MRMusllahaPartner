  ...
  <div>
    <v-sheet class="overflow-hidden menu_header">
      ...
      >
        ...
        <NuxtLink :to="localePath('/notifications')" v-if="allAuth.checkAuth">
          <v-list-item link>
            <v-list-item-icon>
        ...
        <NuxtLink :to="localePath('/my-work')" v-if="allAuth.checkAuth">
          <v-list-item link>
            <v-list-item-icon>
        ...
        <NuxtLink :to="localePath('/my-earnings')" v-if="allAuth.checkAuth">
          <v-list-item link>
            <v-list-item-icon>
              <font-awesome-icon icon="dollar-sign" class="fa" />
            </v-list-item-icon>
